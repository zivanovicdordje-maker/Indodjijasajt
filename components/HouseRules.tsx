        ...
        <div className="space-y-8">
          ...
          <div className="text-gray-600 space-y-6 text-sm leading-relaxed">
            <section>
              ...
              <p>Zakupac prostora preuzima punu materijalnu odgovornost za svu štetu nastalu na inventaru, opremi ili samom objektu tokom trajanja zakupa. Sva oštećenja biće procenjena i naplaćena odmah po završetku termina, po važećem cenovniku reparacije.

Prilikom organizacije dečijih rođendana, zakupac je dužan da obezbedi da sve dečije igračke, rekviziti i animacije budu vraćeni na svoje mesto u ispravnom stanju po završetku događaja. U slučaju nestanka, oštećenja ili nekompletnosti, zakupac je u obavezi da iste nadoknadi u punom iznosu prema važećem cenovniku ili tržišnoj vrednosti.</p>
            </section>
