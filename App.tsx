...
const GALLERY_IMAGES = [
  ...
  "./slike/galerija/sanker.jpg",
  "./slike/galerija/zurka5.jpg"  
];
        ...
        <div className="fixed inset-0 z-[5000] bg-[var(--dark-green)] text-white overflow-y-auto animate-fade-up">
           ...
           <div className="max-w-4xl mx-auto px-6 py-32 space-y-16">
              ...
              <div className="grid md:grid-cols-2 gap-10 md:gap-16 text-base md:text-lg leading-relaxed text-white/80 font-light">
                 ...
                 <p>Od intimnih proslava rođenja i krštenja, do spektakularnih punoletstava i korporativnih događaja, naš vrt se prilagođava vašoj viziji. Sa kapacitetom do 200 gostiju na otvorenom, svaka proslava dobija notu prirode.</p>
              </div>
              ...
              <div className="space-y-8">
                 ...
                 <div className="grid md:grid-cols-3 gap-6 md:gap-8">
                    {[
                       { t: 'Ambijent', d: 'Postepeno uredjen prostor sa osvetljenjem i konstantnim dodavanjem novih detalja.' },
                       { t: 'Prilagodljivost', d: 'Zatvoreni prostor za hladnije dane sa grejanjem i klimatizacijom.' },
                       { t: 'Kvalitet', d: 'Saradnja sa najboljim kuvarima, fotografima i dekoraterima u Inđiji.' }
                    ].map(f => (
      ...
      <section id="utisci-sekcija" className="py-24 px-6 md:px-12 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 space-y-4">
             <h2 className="font-display text-5xl md:text-8xl text-[var(--dark-green)] leading-none">Utisci Gostiju</h2>
             <div className="w-16 md:w-24 h-px bg-[var(--gold)] mx-auto"></div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-24 mb-24 md:mb-32 text-center md:text-left">
            ...
            <div className="space-y-8 md:space-y-10">
               ...
               <div className="space-y-4 md:space-y-6">
                  ...
                  <p className="text-white/50 text-[9px] md:text-[11px] uppercase tracking-widest font-bold">indodjija023@gmail.com</p>
               </div>
            </div>
            <div className="space-y-8 md:space-y-10">
